...
public class VoiceChatViewActivity extends AppCompatActivity {
   ...
   // String appId = "";
    Session session;
   // String time,  name, image, session_id;
    String positivityrating = "0",
            listeninigrating = "0",
            problemrating = "0", msg;
    String is_accpet;
...
//            type = intent.getStringExtra("type");
            is_accpet = intent.getStringExtra("is_accpet");
//            expertid = intent.getStringExtra("expertid");
//            userid = intent.getStringExtra("userid");


            Log.e(TAG, "onReceive: " + is_accpet);


            if (is_accpet.equalsIgnoreCase("expert_ended")) {
    ...
    private RtcEngine mRtcEngine; // Tutorial Step 1
    private Intent intentMicService;
    int  Profile=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        ...
        txtexpertname = findViewById(R.id.txtexpertname);
        friednimage = findViewById(R.id.friednimage);
...
Profile", 0)*//*
       ...
       // accessToken="0062598f457c6f643789ee790a606528f7cIADVU13oUu8+oobAMuqj7DfYD1LKT3Yjsgql3M18DFNU8ShzLA8AAAAAIgArCHcEkcg9YgQAAQAhhTxiAwAhhTxiAgAhhTxiBAAhhTxi";
      //  channelName="cafleg";
      //  appId="2598f457c6f643789ee790a606528f7c";
    ...
    // Tutorial Step 3
    private void leaveChannel() {
        Log.e(TAG, "leaveChannel:aftercall ");
        mRtcEngine.leaveChannel();
    }
...
//        showLongToast(String.format(Locale.US, "user %d left %d", (uid & 0xFFFFFFFFL), reason));
    ...
    public void onResume() {
        super.onResume();
       // registerReceiver(mMessageReceiver, new IntentFilter("endcallrequestexpert"));
    ...
    public void onPause() {
      ...
      //  unregisterReceiver(mMessageReceiver);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Log.e(TAG, "onPause: foreground=-=-=-=-=-=-   ");
            startForegroundService(intentMicService);

        } else {
            startService(intentMicService);
