...
public class HeadsUpNotificationService extends Service implements MediaPlayer.OnPreparedListener  {
    private String channelName="",token="",plumberId="";
    private String CHANNEL_ID = AppController.getContext().getString(R.string.app_name)+"CallChannel";
    private String CHANNEL_NAME = AppController.getContext().getString(R.string.app_name)+"Call Channel";MediaPlayer mediaPlayer;
    Vibrator mvibrator;
...
//            }
    ...
    e.printStackTrace();
        ...
        try {
            Intent receiveCallAction = new Intent(AppController.getContext(), CallNotificationActionReceiver.class);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                ...
                receiveCallPendingIntent = PendingIntent.getBroadcast(AppController.getContext(),
                        1200, receiveCallAction, PendingIntent.FLAG_UPDATE_CURRENT);
                cancelCallPendingIntent = PendingIntent.getBroadcast(AppController.getContext(),
                        1201, cancelCallAction, PendingIntent.FLAG_UPDATE_CURRENT);
                callDialogPendingIntent = PendingIntent.getBroadcast(AppController.getContext(),
                        1202, callDialogAction, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void createChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
           ...
           /* channel.setSound(ringUri,
                ...
                Objects.requireNonNull(AppController.getContext().getSystemService(NotificationManager.class)).createNotificationChannel(channel);
