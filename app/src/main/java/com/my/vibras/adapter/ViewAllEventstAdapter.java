...
public class ViewAllEventstAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private Context mContext;
    private ArrayList<SuccessResGetEvents.Result> modelList;
    private OnItemClickListener mItemClickListener;

    public ViewAllEventstAdapter(Context context, ArrayList<SuccessResGetEvents.Result> modelList) {
