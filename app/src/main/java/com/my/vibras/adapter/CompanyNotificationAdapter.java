...
public class CompanyNotificationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private Context mContext;
    private ArrayList<SuccessResGetNotification.Result> modelList;
    private OnItemClickListener mItemClickListener;

    public CompanyNotificationAdapter(Context context, ArrayList<SuccessResGetNotification.Result> modelList) {
